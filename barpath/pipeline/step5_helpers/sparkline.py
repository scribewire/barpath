...
showing barbell vertical velocity over time.
"""
...
def draw_velocity_sparkline(frame, df, frame_width, frame_height, lift_type):
    ...
    # Draw "Velocity" label
    cv2.putText(frame, "Velocity", (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX,
                0.5, SPARKLINE_AXIS_COLOR_BGR, 1, cv2.LINE_AA)
