...
def get_optional_packages(hardware_profile: Dict[str, Any]) -> Tuple[List[str], List[str]]:
    """
...
def get_available_runtimes_for_model(model_path: str) -> Dict[str, str]:
    ...
    is_openvino_dir = model_path_obj.is_dir() and any('openvino' in part.lower() for part in model_path_obj.parts)
